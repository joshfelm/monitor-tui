...
struct Monitor {
    name: String,
    resolution: (i32, i32),                                 // Selected resolution
    displayed_resolution: (i32, i32),                       // Resolution used may be different due to scale
...
fn get_monitor_info(debug: bool) -> io::Result<Vec<Monitor>> {
    let output = Command::new("xrandr")
        .arg("--query")
        .output()?;
